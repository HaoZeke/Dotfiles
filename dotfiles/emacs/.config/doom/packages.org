...
#+END_SRC
*** Editorconfig
[[https://editorconfig.org/][This]] is actually not a syntax highlighting package per se, but it allows for
interoperable syntax standards for a bunch of editors so it belongs here.
#+BEGIN_SRC emacs-lisp
