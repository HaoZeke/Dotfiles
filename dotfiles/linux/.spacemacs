...
values."
  (setq-default
   ...
   '(ruby
     ...
     pandoc
     go
     ;; ibuffer options are modes [default], projects or nil
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Attribute Mono"
                               :size 20
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)
...
you should place your code here."
  ...
  (use-package magithub
    ...
    (setq auto-mode-alist
          (append
           (list
            '("\\.\\(.\*rc\\|\.*Specifics\\|\.*zsh\\)$" . shell-script-mode)
            )
           auto-mode-alist))
    ;; Minor mode hooks
    (use-package manage-minor-mode)
    ;; Using https://github.com/ShingoFukuyama/manage-minor-mode
    (setq manage-minor-mode-default
          '((markdown-mode
             (on   cdlatex-mode markdown-toggle-math auto-fill-mode))
        (emacs-lisp-mode
         (off  flyspell-mode))))
  )
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (rvm ruby-tools ruby-test-mode ruby-refactor ruby-hash-syntax rubocop rspec-mode robe rbenv rake minitest chruby ox-reveal anki-editor go-guru go-eldoc company-go go-mode flyspell-popup git-gutter-fringe+ git-gutter-fringe fringe-helper git-gutter+ git-gutter flyspell-correct-helm flyspell-correct flycheck-pos-tip pos-tip flycheck diff-hl auto-dictionary fzf pandoc-mode ox-pandoc ht org-ref key-chord ivy helm-bibtex parsebib deft biblio biblio-core helm-company helm-c-yasnippet fuzzy company-statistics company-auctex company auto-yasnippet yasnippet all-the-icons memoize ac-ispell auto-complete interleave pdf-tools tablist auctex-latexmk auctex unfill smeargle orgit org-projectile org-category-capture org-present org-pomodoro alert log4e gntp org-mime org-download mwim mmm-mode markdown-toc markdown-mode magit-gitflow htmlize helm-gitignore gnuplot gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link gh-md evil-magit magit magit-popup git-commit ghub let-alist with-editor ws-butler winum which-key volatile-highlights vi-tilde-fringe uuidgen use-package toc-org spaceline powerline restart-emacs request rainbow-delimiters popwin persp-mode pcre2el paradox spinner org-plus-contrib org-bullets open-junk-file neotree move-text macrostep lorem-ipsum linum-relative link-hint indent-guide hydra hungry-delete hl-todo highlight-parentheses highlight-numbers parent-mode highlight-indentation helm-themes helm-swoop helm-projectile helm-mode-manager helm-make projectile pkg-info epl helm-flx helm-descbinds helm-ag google-translate golden-ratio flx-ido flx fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-lisp-state smartparens evil-indent-plus evil-iedit-state iedit evil-exchange evil-escape evil-ediff evil-args evil-anzu anzu evil goto-chg undo-tree eval-sexp-fu highlight elisp-slime-nav dumb-jump f dash s diminish define-word column-enforce-mode clean-aindent-mode bind-map bind-key auto-highlight-symbol auto-compile packed aggressive-indent adaptive-wrap ace-window ace-link ace-jump-helm-line helm avy helm-core popup async))))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
